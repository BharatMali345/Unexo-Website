...
const routes: Routes = [
  ...
  { path: "funds-raising", component: FundsRaisingComponent },
  ...
  {
    path: 'personal-details', loadChildren: () =>
      import("./container/personal-details/personal-details.module").then(m => m.PersonalDetailsModule), canActivate: [AuthGuard]
  },
  {
    path: 'user-profile', loadChildren: () =>
      import("./container/user-profile/user-profile.module").then(m => m.UserProfileModule), canActivate: [AuthGuard]
  },
  {
    path: 'admin-profile', loadChildren: () =>
      import("./container/admin-profile/admin-profile.module").then(m => m.AdminProfileModule), canActivate: [AdminLoginGuard]
  },
  {
    path: 'hr-profile', loadChildren: () =>
      import("./container/hr-profile/hr-profile.module").then(m => m.HrProfileModule), canActivate: [HrGuard]
  },
